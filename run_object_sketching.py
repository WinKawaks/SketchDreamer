...
parser.add_argument("--num_iter", type=int, default=1001,
...
abs_path = '/home/SketchDreamer'

target = f"{abs_path}/input/{args.target_file}"
...
seeds = list(range(0, args.num_sketches * 1, 1))
...
def run(seed, wandb_name):
    exit_code = sp.run(["python", f"{abs_path}/painterly_rendering.py", target,
