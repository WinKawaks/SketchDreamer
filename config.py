...
def parse_arguments():
    ...
    parser.add_argument("--color_lr", type=float, default=0)
    ...
    parser.add_argument("--num_paths", type=int,
                        default=8, help="number of strokes")
    ...
    parser.add_argument("--num_aug_clip", type=int, default=1)
    ...
    parser.add_argument('--fp16', type=str_to_bool, nargs='?', const=True, default=True)
