...
class StableDiffusion(nn.Module):
    def __init__(self, args, fp16, vram_O, sd_version='1.5', hf_key=None):
        ...
        if hf_key is not None:
            ...
            control_key = "thibaud/controlnet-sd21-scribble-diffusers"
        elif self.sd_version == '1.5':
            model_key = "runwayml/stable-diffusion-v1-5"
            control_key = "lllyasviel/control_v11p_sd15_scribble"
        else:
        ...
        if self.control:
            ...
            controlnet = ControlNetModel.from_pretrained(control_key, torch_dtype=precision_t)

            pipe = StableDiffusionControlNetPipeline.from_pretrained(
                model_key, controlnet=controlnet, safety_checker=None, torch_dtype=precision_t)
        else:
        ...
        self.min_step = int(self.num_train_timesteps * 0.05)
        self.max_step = int(self.num_train_timesteps * 0.95)
